...
class TwitterAPICaller: BDBOAuth1SessionManager {
    ...
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "3eygbnSya4p5ChVzwtNOgrsKe", consumerSecret: "TiKLPqNJPeNP2HEsCEtc42adlsio5K5g6l3lndofpKvEerktFC")
    var loginSuccess: (() -> ())?
